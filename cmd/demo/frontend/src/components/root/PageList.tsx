function PageList() {
    return (
      <div className="my-1 pl-6 flex-row flex border-b border-gray-300">
        ...
        <a href="/ServiceSecurity" className="block px-3 text-gray-800 font-medium my-2">Data tools</a>
        <a href="/" className="block px-4 text-gray-800 font-bold my-2">Service Discovery</a>
      </div>
    );
  }
